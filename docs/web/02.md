...
より詳しく知りたい方は
[こちら](https://github.com/yashikota/meetup/blob/master/etc/vscode.md)
のリンクを参照して下さい。  
...
HTMLとは？  
Hyper Text Markup Languageの略称でWebページのテキストとその構造を示した言語。~~HTMLをプログラミング言語と言うと消されます~~  
タグ```<>```で囲んで構造を表現します。  
...
このような
[Webページ](https://yashikota.github.io/meetup/mini/../../../assets/images/02-sample.html)
を作ってみよう！
...
いくつか要素を追加したのが
[こちら](https://yashikota.github.io/meetup/mini/../../../assets/images/02-bootstrap.html)
